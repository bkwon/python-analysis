...
table, fieldnames = dictparse("../data/hightemp.csv", 'City', ',', '"', csv.QUOTE_MINIMAL)
print(fieldnames)
...
table2, fieldnames2 = dictparse("../data/hightemp2.csv", 'City', ',', '"', csv.QUOTE_NONNUMERIC)
print_table(table2, fieldnames2)

print("")
print("")

table3, fieldnames3 = dictparse("../data/hightemp3.csv", 'City', ' ', "'", csv.QUOTE_NONNUMERIC)
